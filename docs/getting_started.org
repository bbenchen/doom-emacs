...
+ Use the ~modulep!~ macro to make some configuration conditional based on the
...
+ Use the ~modulep!~ macro to make packages conditional based on the state of
